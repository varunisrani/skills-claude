<!-- UNDER BUILD BANNER -->
<div align="center">
  <h2>🚧 UNDER BUILD - CLAUDE ADVANCED PM 🚧</h2>
  ...
  <p><em>Enhanced version of Claude Code PM with advanced features</em></p>
  <hr>
</div>
...
**Based on: [Claude Code PM (CCPM)](https://github.com/automazeio/ccpm) by Automaze.io**
...
&nbsp;
[![Star Original](https://img.shields.io/github/stars/automazeio/ccpm.svg?style=social&label=Star%20Original&maxAge=60)](https://github.com/automazeio/ccpm)
...
> **⚠️ This is an experimental enhancement branch.** For the stable, production-ready version, visit [Claude Code PM on GitHub](https://github.com/automazeio/ccpm).
