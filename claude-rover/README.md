<!-- UNDER BUILD BANNER -->
<div align="center">
  <h2>🚧 UNDER BUILD - CLAUDE-ROVER PROJECT 🚧</h2>
  <p><strong>⚠️ WARNING: This is an experimental development branch - NOT production ready ⚠️</strong></p>
  <p>
    <a href="./STATUS.md"><img src="https://img.shields.io/badge/Status-Under%20Build-orange?style=for-the-badge" alt="Under Build"></a>
    <a href="./UNDER_BUILD.txt"><img src="https://img.shields.io/badge/Stability-Experimental-red?style=for-the-badge" alt="Experimental"></a>
    <img src="https://img.shields.io/badge/Production-Not%20Ready-red?style=for-the-badge" alt="Not Production Ready">
  </p>
  <p><em>Claude-optimized version of Rover - AI coding agent manager</em></p>
  <hr>
</div>
<!-- END UNDER BUILD BANNER -->
...
<div align="center">
  ...
  <h1>Claude-Rover (Based on Rover)</h1>
...
**This is Claude-Rover** - an experimental development branch based on Rover by Endor.

This project is **UNDER BUILD** and focuses on:
- 🤖 **Enhanced Claude Code Integration** - Optimized workflows for Claude
- 🛠️ **Claude-Specific Features** - Advanced Claude Agent SDK capabilities
- 🧪 **Experimental Development** - Testing Claude-centric improvements

**Status:** Not stable | Not production-ready | Under active development

See [STATUS.md](./STATUS.md) for current development status and [UNDER_BUILD.txt](./UNDER_BUILD.txt) for warnings.

### 🖥️ Web Interface Available

Claude-Rover includes a **modern Next.js frontend** for visual task management:
- Dashboard for managing AI agent tasks
- Real-time monitoring and progress tracking
- Built-in terminal and code diff viewer
- Accessible with keyboard shortcuts

**📖 Read:** [FRONTEND_GUIDE.md](./FRONTEND_GUIDE.md) for complete setup and usage instructions.

---

## 📖 Original Project: Rover
...
**Original Project:** [Rover by Endor](https://github.com/endorhq/rover) | [Documentation](https://docs.endor.dev/rover)
