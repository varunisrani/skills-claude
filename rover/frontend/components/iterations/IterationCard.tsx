  ...
  return (
    <Card className="hover:border-zinc-400 dark:hover:border-zinc-600 transition-colors">
      ...
      <CardContent>
        ...
        <Link
          href={`/tasks/${taskId}/logs?iteration=${iteration.iteration}`}
          className="mt-3 inline-flex items-center gap-1 text-sm text-zinc-900 hover:underline dark:text-zinc-50"
        >
