...
<!-- UNDER BUILD BANNER -->
<div align="center">
  <h2>🚧 UNDER BUILD - DEVIN-CLAUDE PROJECT 🚧</h2>
  ...
  <p><em>This is a development branch integrating Claude SDK with OpenHands architecture</em></p>
  <hr>
</div>
...
<div align="center">
  ...
  <h1 align="center">Devin-Claude (Based on OpenHands)</h1>
</div>
...
**This is Devin-Claude** - an experimental development branch based on OpenHands (formerly OpenDevin).

This project is **UNDER BUILD** and integrates:
- 🤖 **Claude Agent SDK** - Anthropic's AI agent framework
- 🛠️ **OpenHands Infrastructure** - AI software development platform
- 🧪 **Custom Integration** - Experimental Devin-Claude architecture
...
Welcome to the base project: **OpenHands** (formerly OpenDevin), a platform for software development agents powered by AI.

OpenHands agents can do anything a human developer can: modify code, run commands, browse the web,
call APIs, and yes—even copy code snippets from StackOverflow.

**Original Project:** Learn more at [docs.all-hands.dev](https://docs.all-hands.dev), or [sign up for OpenHands Cloud](https://app.all-hands.dev).
